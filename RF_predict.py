...
dist_list = [
    "AGARMALWA", "ALIRAJPUR", "ANUPPUR", "ASHOKNAGAR", "BALAGHAT", 
    "BARWANI", "BETUL", "BHOPAL", "BURHANPUR", "CHHATARPUR", "CHHINDWARA", 
    ...
    "PACHMARHI", "PANNA", "REWA", "SAGAR", "SEHORE", "SHIVPURI"
]
...
api_key = "fdb3446b9be4cde209e94ab3312a8ef9"    # Use your own API key. You can get it for free from openweathermap
